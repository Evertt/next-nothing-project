	...
	<div class="my-8 w-full">
		...
		<div class="flex place-content-center">
			<div class="join join-vertical mx-auto max-w-xl py-6">
				<div class="collapse join-item collapse-arrow border border-primary">
		...
		<div class="mx-auto mt-4 max-w-xl overflow-visible">
			<table class="table">
				<thead
					class="sticky top-0 z-10 bg-base-100 bg-opacity-50 text-lg backdrop-blur"
				>
					<tr>
						<th></th>
								...
								<td class="text-center">
									...
									{:else if feature.freeIncluded}
										<svg
											...
											class="ml-2 inline h-8 w-8 text-success"
										>
									...
									{:else}
										<svg
											xmlns="http://www.w3.org/2000/svg"
											class="inline h-[26px] w-[26px] text-base-200"
										>
											<use href="#nocircle" />
										</svg>
									{/if}
